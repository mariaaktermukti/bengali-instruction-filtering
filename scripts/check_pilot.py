...
print("Duplicate instructions:", total - len(unique_instructions))
...
for example in examples:
    ...
    pairs.add((instruction, response))

print("\nInstruction-response duplicates")
print("Unique pairs:", len(pairs))
print("Duplicate pairs:", total - len(pairs))
...
print("Average:", round(sum(instruction_lengths) / total, 2))

print("\nResponse")
print("Minimum:", min(response_lengths))
print("Maximum:", max(response_lengths))
print("Average:", round(sum(response_lengths) / total, 2))
...
print("\nVery short examples")
print("Instructions < 10 characters:", short_instructions)
print("Responses < 20 characters:", short_responses)
